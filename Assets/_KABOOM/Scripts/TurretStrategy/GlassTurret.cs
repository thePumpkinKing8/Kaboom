...
/// </summary>
public class GlassTurret : MonoBehaviour
{
    public IShoot CurrentShotType; // The specific type of shooting to be used

    public static GlassTurret SharedInstance; // For the bullet pool
    ...
    protected float _shotSpeed = 10f; // How fast the bullet comes out

    protected float _shotDelay = 5f; // Time between shots
