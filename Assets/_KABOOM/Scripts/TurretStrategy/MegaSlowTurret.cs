...
/// </summary>
public class MegaSlowTurret : MonoBehaviour
{
    public IShoot CurrentShotType; // The specific type of shooting to be used

    public static MegaSlowTurret SharedInstance; // For the bullet pool
    ...
    protected float _shotSpeed = 0.5f; // How fast the bullet comes out

    protected float _shotDelay = 2.5f; // Time between shots
    ...
    protected float _bulletLifetime = 20f; // How long until bullets are set inactive
